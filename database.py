...
# (but environment loading is now correct & container-safe)
DB_CONFIG = {
    "dbname": os.getenv("DB_NAME"),
    "user": os.getenv("DB_USER"),
    "password": os.getenv("DB_PASSWORD"),  # CWE-259 still valid if .env has weak password
    "host": os.getenv("DB_HOST", "db"),    # default for Docker Compose
